...
export const CAT_VISUAL_BG: Record<string, string> = {
  everyday: "linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%)",
  digital:  "linear-gradient(135deg, #eef2ff 0%, #e0e7ff 100%)",
  india:    "linear-gradient(135deg, #fdf2f8 0%, #fce7f3 100%)",
  street:   "linear-gradient(135deg, #fefce8 0%, #fef9c3 100%)",
  body:     "linear-gradient(135deg, #fff1f2 0%, #ffe4e6 100%)",
  home:     "linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)",
};
